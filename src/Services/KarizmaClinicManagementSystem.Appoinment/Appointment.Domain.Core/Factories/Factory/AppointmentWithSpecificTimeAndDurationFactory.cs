...
public class AppointmentWithSpecificTimeAndDurationFactory
{
    ...
    public AppointmentWithSpecificTimeAndDurationFactory(IDoctorRepository doctorRepository,
    ...
    public IAppointment GetAppointment(Guid doctorId,Guid patientId,DateTime startDate, int duration)
    {
        return new AppointmentWithSpecificTimeAndDuration(doctorRepository,
