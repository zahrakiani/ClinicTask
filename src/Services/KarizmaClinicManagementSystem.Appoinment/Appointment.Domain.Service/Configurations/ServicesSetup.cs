...
using Appointment.Domain.Service.Services.ApoinmentService;
using Appointment.Domain.Service.Services.DoctorService;
using Appointment.Domain.Service.Services.PatientService;
...
namespace Appointment.Domain.Service.Configurations;
